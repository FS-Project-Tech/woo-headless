...
export default function Footer() {
	...
	return (
		<footer className="bg-gray-900 text-gray-300 border-t border-gray-800">
			<div className="mx-auto w-[85vw] px-4 sm:px-6 lg:px-8 py-16">
				{/* 4 Column Layout */}
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-12">
					{/* Column 1: Image/Logo */}
					<div className="space-y-4">
						<div className="flex items-center gap-3">
							<div className="h-12 w-12 rounded bg-blue-600 text-white grid place-items-center text-xl font-bold">
								W
							</div>
							<span className="text-white font-semibold text-lg">WooCommerce Store</span>
						</div>
					...
					<div>
						...
						<ul className="space-y-3">
							...
							<li>
								<Link href="/my-wishlist" className="text-gray-400 hover:text-white transition-colors">
									Wishlist
								</Link>
							</li>
							<li>
					...
					<div>
						...
						<p className="text-sm text-gray-400 mb-4">
							Stay connected with us on social media for updates, promotions, and news.
						</p>
