...
export default function CheckoutCartPage() {
  ...
  const [shippingCost] = useState<number>(0); // Will be calculated in next step
  ...
  const handleContinue = () => {
    ...
    const token = searchParams.get("token") || getStoredToken();
    router.push(`/checkout/details?token=${token}`);
  };
  ...
  // Show loading/redirecting state if not mounted or not authorized
          ...
          <div className="lg:col-span-1">
            <div className="rounded-xl border bg-white p-6 sticky top-4">
              ...
              <button 
                ...
                className="mt-6 w-full rounded-md bg-gray-900 px-4 py-3 text-sm font-medium text-white hover:bg-black disabled:bg-gray-400 disabled:cursor-not-allowed"
              >
